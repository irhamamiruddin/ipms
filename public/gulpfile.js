...
gulp.task('injectLayoutStyles', function () {
    var verticalLightStream = gulp.src(['./**/vertical-default-light/**/*.html',
        ...
        .pipe(gulp.dest('.'));
    var horizontalLightStream = gulp.src('./**/horizontal-default/**/*.html')
        .pipe(inject(gulp.src([
    ...
    var verticalDarkStream = gulp.src('./**/vertical-default-dark/**/*.html')
        ...
        .pipe(gulp.dest('.'));
    return merge(verticalLightStream, horizontalLightStream, horizontalDarkStream, horizontalLightStream, verticalDarkStream);
});
...
gulp.task('copyAddonsStyles', function() {
    ...
    var aStyle57 = gulp.src(['node_modules/dropzone/dist/dropzone.css'])
        .pipe(gulp.dest('./vendors/dropzone'));
    var aStyle58 = gulp.src(['node_modules/bootstrap-tour/build/css/bootstrap-tour-standalone.min.css'])
        .pipe(gulp.dest('./vendors/bootstrap-tour'));
    var aStyle59 = gulp.src(['node_modules/icheck/skins/**/*'])
    .pipe(gulp.dest('./vendors/icheck/skins'));
    return merge(aStyle1, aStyle2, aStyle3, aStyle4, aStyle5, aStyle6, aStyle7, aStyle8, aStyle9, aStyle10, aStyle11, aStyle12, aStyle13, aStyle14, aStyle15, aStyle16, aStyle17, aStyle18, aStyle19, aStyle20, aStyle21, aStyle22, aStyle23, aStyle24, aStyle25, aStyle26, aStyle27, aStyle28, aStyle29, aStyle30, aStyle31, aStyle32, aStyle33, aStyle34, aStyle35, aStyle36, aStyle37, aStyle38, aStyle39, aStyle40, aStyle41, aStyle42, aStyle43, aStyle44, aStyle45, aStyle46, aStyle47, aStyle48, aStyle49, aStyle50, aStyle51, aStyle53, aStyle54, aStyle55, aStyle56, aStyle57, aStyle58, aStyle59);
});
